  ...
  return (
    <section id="home" className="hero container">
      ...
      <div className="hero-stage hero-enter hero-delay-2" aria-label="Animated preview of featured ecommerce work">
        ...
        <a className="hero-project-card hero-moto" href="https://moto-drive.vercel.app/" target="_blank" rel="noreferrer" aria-label="Open MotoDrive project"><span>04 / MOTODRIVE</span><img src="https://moto-drive.vercel.app/images/motodrive-hero.png" alt="MotoDrive website preview" /></a>
